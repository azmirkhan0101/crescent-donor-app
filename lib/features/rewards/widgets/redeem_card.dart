...
class RedeemCard extends StatelessWidget {
  ...
  void _showRewardDetailsBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => Material(
        ...
        child: RewardDetailsBottomSheet(index: index),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => _showRewardDetailsBottomSheet(context),
      child: Card(
        child: Column(
...
class RewardDetailsBottomSheet extends StatelessWidget {
  const RewardDetailsBottomSheet({super.key, required this.index});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFFA6F6E6).withOpacity(0.25),
